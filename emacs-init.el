...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elpy hydra web-mode xref-js2 js2-refactor dap-mode lsp-java company-lsp ansible company-ansible flycheck-gradle flymake-gradle gradle-mode rope-read-mode lsp-ui magit use-package tide plantuml-mode json-mode memory-usage mvn eclim company-emacs-eclim go-dlv django-mode docker-compose-mode dockerfile-mode ox-reveal git-link puppet-mode angular-mode ein jinja2-mode markdown-mode nginx-mode icicles helm-projectile helm groovy-mode dot-mode dumb-jump go-projectile go-mode terraform-mode solarized-theme babel racer company-racer yaml-mode slack mmm-mode alchemist elixir-mode)))
